...
#include "../../../../Client/UI/TrainUI/syslog.h"
...
const QMetaObject sysLog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_sysLog.data,
      qt_meta_data_sysLog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *sysLog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_sysLog.stringdata0))
        return static_cast<void*>(const_cast< sysLog*>(this));
