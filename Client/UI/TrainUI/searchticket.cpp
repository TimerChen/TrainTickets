    ...
    ui(new Ui::SearchTicket)
{
   ...
   // ui->ticketsTableView->horizontalHeader()->setSectionResizeMode(QHeaderView::ResizeToContents);
    ...
    model->setItem(0,1,new QStandardItem("233"));
    model->setItem(0,2,new QStandardItem("闵行"));
    model->setItem(0,3,new QStandardItem("升天"));
    model->setItem(0,4,new QStandardItem("24：01"));
    model->setItem(0,5,new QStandardItem("24：02"));
    model->setItem(0,6,new QStandardItem("双脚"));
    model->setItem(0,7, new QStandardItem("666"));
    model->setItem(0,8,new QStandardItem("100"));
    model->setItem(0,9,new QStandardItem("是"));

    model->setItem(0,0,new QStandardItem("1"));
    model->setItem(1,1,new QStandardItem("33"));
    model->setItem(1,2,new QStandardItem("升天"));
    model->setItem(1,3,new QStandardItem("闵行"));
    model->setItem(1,4,new QStandardItem("24：01"));
    model->setItem(1,5,new QStandardItem("24：02"));
    model->setItem(1,6,new QStandardItem("双脚"));
    model->setItem(1,7, new QStandardItem("999"));
    model->setItem(1,8,new QStandardItem("105"));
    model->setItem(1,9,new QStandardItem("是"));
