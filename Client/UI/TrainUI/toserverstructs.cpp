...
frontask::stationToStationSearch::stationToStationSearch(QDate _time, QString _from, QString _to)
        : fromStation(_from), toStation(_to), time(_time) {}
frontask::stationToStationSearch::stationToStationSearch(const stationToStationSearch &rs)
...
frontask::trainSearch::trainSearch(QDate _time, QString _train):time(_time),trainID(_train){}
