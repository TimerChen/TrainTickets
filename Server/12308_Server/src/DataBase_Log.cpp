...
{
	log.push_back( QDateTime::currentDateTime().toString("yyyy-MM-dd hh:mm:ss ddd") + name+"("+AccId+") bought "+QString::number(num)+
	" Tickets("+set+") from "+lsta+" to "+ulsta+" in Train "+traId+" at "+dat.toString());
	ticLog.push_back( QDateTime::currentDateTime().toString("yyyy-MM-dd hh:mm:ss ddd") + name+"("+AccId+") bought "+QString::number(num)+
	" Tickets("+set+") from "+lsta+" to "+ulsta+" in Train "+traId+" at "+dat.toString());
}
...
{
	log.push_back( QDateTime::currentDateTime().toString("yyyy-MM-dd hh:mm:ss ddd") + name+"("+AccId+") queried information about Train "+traId);
	qstLog.push_back( QDateTime::currentDateTime().toString("yyyy-MM-dd hh:mm:ss ddd") + name+"("+AccId+") queried information about Train "+traId);
}
void DataBase_Log::questOne(/*const QDateTime &now,*/const QString &AccId, const QString &name, const QString &staId)
{
	log.push_back( QDateTime::currentDateTime().toString("yyyy-MM-dd hh:mm:ss ddd") + name+"("+AccId+") queried all Trains pass station "+staId);
	qstLog.push_back( QDateTime::currentDateTime().toString("yyyy-MM-dd hh:mm:ss ddd") + name+"("+AccId+") queried all Trains pass station "+staId);
}
void DataBase_Log::questTwo(/*const QDateTime &now,*/const QString &AccId, const QString &name,
 const QString &sta, const QString &stb)
{
	log.push_back( QDateTime::currentDateTime().toString("yyyy-MM-dd hh:mm:ss ddd") + name+"("+AccId+
	") queried information about Trains pass both station "+sta+" and station "+stb);
	qstLog.push_back( QDateTime::currentDateTime().toString("yyyy-MM-dd hh:mm:ss ddd") + name+"("+AccId+
	") queried information about Trains pass both station "+sta+" and station "+stb);
}
...
{
	log.push_back( QDateTime::currentDateTime().toString("yyyy-MM-dd hh:mm:ss ddd") + "Admin "+name+"("+AccId+
	") queried all buy(return) tickets operations of user "+qname+"("+id+")");
	qstLog.push_back( QDateTime::currentDateTime().toString("yyyy-MM-dd hh:mm:ss ddd") + "Admin "+name+"("+AccId+
	") queried all buy(return) tickets operations of user "+qname+"("+id+")");
}
void DataBase_Log::questLog(/*const QDateTime &now,*/const QString &AccId, const QString &name)
{
	log.push_back( QDateTime::currentDateTime().toString("yyyy-MM-dd hh:mm:ss ddd") + "Admin "+name+"("+AccId+") viewed the Log");
	qstLog.push_back( QDateTime::currentDateTime().toString("yyyy-MM-dd hh:mm:ss ddd") + "Admin "+name+"("+AccId+") viewed the Log");
}
...
void DataBase_Log::modifyAccount(/*const QDateTime &now,*/const QString &AccId, const QString &name)
{
	...
	accLog.push_back( QDateTime::currentDateTime().toString("yyyy-MM-dd hh:mm:ss ddd") + "User "+AccId+" modified self information and now he calls "+name);
}
