...
DataBase_Account::ticLog::ticLog(){}

DataBase_Account::ticLog::ticLog(const QString&tra,
...
DataBase_Account::Ticket::Ticket(){}

DataBase_Account::Ticket::Ticket(const QString&name, const QString&st, const QString&ed,
			   const QString&tra, const QDateTime &stt, const QDateTime &edt,
			   const int &pri, const QString&stp)
	:buyer(name), loadStation(st), unLoadStation(ed),
	 trainID(tra), loadTime(stt), unLoadTime(edt),
