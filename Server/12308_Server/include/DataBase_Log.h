...
public:
	...
	void buyTicket(/*const QDateTime &now,*/const int &UserId, const QString &AccId, const QString &traId,
	 const QDate &dat, const QString &lsta, const QString &ulsta, const QString &set, const int &num);
	void returnTicket(/*const QDateTime &now,+*/const int &UserId, const QString &AccId, const QString &traId,
	 const QDate &dat, const QString &lsta, const QString &ulsta, const QString &set, const int &num);
	void questTrain(/*const QDateTime &now,*/const int &UserId, const QString &traId);
	void questOne(/*const QDateTime &now,*/const int &UserId, const QString &staId);
	void questTwo(/*const QDateTime &now,*/const int &UserId, const QDate &dat, const QString &sta, const QString &stb);
	void questTic(/*const QDateTime &now,*/const int &UserId, const int &id);//*
	void questLog(/*const QDateTime &now,*/const int &UserId );
	void questAcc(/*const QDateTime &now,*/const int &UserId, const QString &qname, const QString &id);
	void newAccount(/*const QDateTime &now,*/const QString &AccId, const QString &name);
	void modifyAccount(/*const QDateTime &now,*/const int &UserId, const int &id);//*
